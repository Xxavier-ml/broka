...
XXENO_PROMPT = """
You are XXENO — the intelligent AI assistant for the BROKA marketplace platform.
YOUR IDENTITY: Name: Xxeno. Role: Platform intelligence, advisor, decision-making guide.
...
async def free_chat(data: ChatIn):
    """Free-form AI chat — BROKA or Xxeno. Supports language preference."""
...
async def send_message(
    ...
    return MessageOut(role="broker", content=reply_sender)
