...
class _UserProfileScreenState extends State<UserProfileScreen> {
  ...
  Widget _buildBody() {
    if (_loadingProfile) {
      return const SizedBox(height: 300,
          child: Center(child: CircularProgressIndicator(color: BrokaColors.neonPurple)));
    }
    if (_profile == null) {
      return const SizedBox(height: 300,
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF0F0830), BrokaColors.bg],
      ...
      child: Column(children: [
        ...
        Stack(alignment: Alignment.bottomRight, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _isVerified
                    ? BrokaColors.gold : BrokaColors.neonPurple.withOpacity(0.5),
        ...
        Wrap(spacing: 8, runSpacing: 6, alignment: WrapAlignment.center, children: [
          ...
          _badge('${_completedDeals} deals', BrokaColors.neonPurple),
    ...
    child: Container(
      ...
      child: Column(children: [
        ...
        Row(children: [
          ...
          const SizedBox(width: 16),
          Expanded(child: _infoItem(Icons.calendar_month_rounded, 'Member Since', _memberSince, BrokaColors.neonPurple)),
        ]),
      ]),
    ),
  );
  ...
  Widget _buildScoresSection() => Padding(
    ...
    child: Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 14),
        _scoreBar('Reliability', _reliabilityScore, BrokaColors.neonPurple),
        const SizedBox(height: 10),
  ...
  Widget _buildRadarSection() => Padding(
    ...
    child: Container(
      ...
      child: Column(children: [
        Row(children: [
          const Icon(Icons.radar_rounded, color: BrokaColors.neonPurple, size: 16),
          const SizedBox(width: 8),
...
class _RadarPainter extends CustomPainter {
  ...
  static const _colors = [
    BrokaColors.neonPurple, BrokaColors.neonBlue, BrokaColors.gold,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(dataPath, Paint()
      ...
      ..color = BrokaColors.neonPurple.withOpacity(0.18));
    canvas.drawPath(dataPath, Paint()
      ..style = PaintingStyle.stroke
