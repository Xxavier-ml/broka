            ...
            Opacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: BrokaColors.neonPurple, width: 1.5),
                ),
              ),
            ),
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(colors: [
                ...
                BrokaColors.neonPurple.withOpacity(0.05),
              ]),
            ),
            child: const Icon(Icons.smart_toy_rounded,
                color: BrokaColors.neonPurple, size: 28),
          ),
        ]),
      ),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (_chatMsgsReviewed > 0)
          Container(
            ...
            decoration: BoxDecoration(
              color: BrokaColors.neonPurple.withOpacity(0.07),
...
class _IssueTypeTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = value == 'fraud' ? Colors.redAccent : BrokaColors.neonPurple;
...
class _DisclaimerNote extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: const Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Icon(Icons.shield_outlined, color: BrokaColors.neonPurple, size: 14),
      SizedBox(width: 8),
      Expanded(child: Text(
