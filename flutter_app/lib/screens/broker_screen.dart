      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: BrokaColors.neonPurple.withOpacity(0.4),
                  blurRadius: 8),
            ],
          ),
          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: isBroker
                    ? Border.all(color: BrokaColors.neonPurple.withOpacity(0.2))
                    : null,
                boxShadow: [
                  BoxShadow(
                    color: (isBroker
                            ? BrokaColors.neonPurple
                            : BrokaColors.gradStart)
                        .withOpacity(0.2),
...
class _BrokerAvatar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      boxShadow: [
        BoxShadow(
            color: BrokaColors.neonPurple.withOpacity(0.4), blurRadius: 6),
      ],
    ),
