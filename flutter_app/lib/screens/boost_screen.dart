...
class _BoostScreenState extends State<BoostScreen>
      ...
      Container(
        ...
        child: Column(children: [
          const Icon(Icons.rocket_launch_rounded,
              color: BrokaColors.neonPurple, size: 40),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            _StatPill(icon: Icons.push_pin_rounded,   label: 'Pinned to top',        color: BrokaColors.neonPurple),
            const SizedBox(width: 8),
        ...
        return Expanded(child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(plan.label,
                  style: TextStyle(
                    color: selected ? BrokaColors.neonPurple : BrokaColors.textHigh,
                    fontWeight: FontWeight.w800, fontSize: 13,
                  )),
              const SizedBox(height: 4),
              Text('KES ${plan.price}',
                  style: TextStyle(
                    color: selected ? BrokaColors.neonPurple : BrokaColors.textMid,
  ...
  Widget _buildPaymentLoading() => const Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      CircularProgressIndicator(color: BrokaColors.neonPurple),
      SizedBox(height: 24),
        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            decoration: BoxDecoration(
              ...
              color: BrokaColors.neonPurple.withOpacity(0.08 + _pulseCtrl.value * 0.06),
              border: Border.all(
                  color: BrokaColors.neonPurple.withOpacity(0.4 + _pulseCtrl.value * 0.3),
                  width: 2),
            ),
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: BrokaColors.neonPurple.withOpacity(0.08 + _pulseCtrl.value * 0.08),
                border: Border.all(
                    color: BrokaColors.neonPurple.withOpacity(0.4 + _pulseCtrl.value * 0.3),
                    width: 2.5),
              ),
              child: const Icon(Icons.rocket_launch_rounded,
                  color: BrokaColors.neonPurple, size: 44),
            ),
          ),
          const SizedBox(height: 24),
