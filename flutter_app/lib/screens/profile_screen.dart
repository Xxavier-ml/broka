...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      Stack(alignment: Alignment.bottomRight, children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                color: BrokaColors.neonPurple.withOpacity(0.5), width: 2),
          ),
          child: ClipOval(
  ...
  Widget _buildSellerDashboardTile() => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            color: BrokaColors.neonPurple.withOpacity(0.45), width: 1.5),
        boxShadow: [BoxShadow(
            color: BrokaColors.neonPurple.withOpacity(0.1), blurRadius: 16)],
      ),
      child: Row(children: [
        Container(
          width: 44, height: 44,
        ...
        const Expanded(child: Column(
          ...
          SizedBox(height: 3),
          Text('Analytics, Zeno tips, scores & boost',
