        ...
        AnimatedBuilder(
          ...
          builder: (_, __) => Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(
                color: BrokaColors.neonPurple.withOpacity(0.3 + 0.3 * _pulseCtrl.value),
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Icon(_ttsEnabled ? Icons.volume_up_rounded : Icons.volume_off_rounded,
                color: _ttsEnabled ? BrokaColors.neonPurple : BrokaColors.textLow, size: 18),
          ),
        ),
      ]),
    ),
  ...
  Widget _dot(int delayMs) => TweenAnimationBuilder<double>(
    ...
    builder: (_, v, __) => Opacity(
      ...
      child: Container(width: 6, height: 6,
          decoration: const BoxDecoration(
              shape: BoxShape.circle, color: BrokaColors.neonPurple)),
    ),
  );
        ...
        children: [
          if (isAI) ...[
            Container(
              ...
              decoration: const BoxDecoration(
                shape: BoxShape.circle,
                gradient: LinearGradient(colors: [BrokaColors.gradStart, BrokaColors.neonBlue]),
              ),
              child: const Icon(Icons.auto_awesome_rounded, color: Colors.white, size: 14),
            ),
            const SizedBox(width: 8),
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isAI
                    ...
                    : BrokaColors.gradStart.withOpacity(0.4)),
              ),
